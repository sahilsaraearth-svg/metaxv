...
import { URLInput } from '@/features/analyzer/components/URLInput';
import { ResultsTabs } from '@/features/analyzer/components/ResultsTabs';
import { ResultsSkeleton } from '@/shared/ui/Skeleton';
      ...
      <section style={{ paddingTop: 72, paddingBottom: 52, textAlign: 'center' }}>
        <div className="container">
          ...
          <h1 style={{
            ...
            Meta Analyzer
            <br />
            <span style={{ color: 'var(--text-muted)' }}>for Links</span>
          </h1>

          <p style={{ fontSize: 13, color: 'var(--text-tertiary)', maxWidth: 400, margin: '0 auto 32px', lineHeight: 1.65 }}>
            Fetch any URL, test meta tags, score quality, and preview
            how it looks across every major platform.
          </p>
...
function EmptyState() {
  const FEATURES = [
    { label: 'Deep Parse', desc: 'All meta & og:* tags via Cheerio' },
